...
def test_best_by_newest():
    item_a = Clothing(age = 0.0)
    item_b = Decor(age = 1.0)
    item_c = Clothing(age = 0.1)
    ...
    best_item = tai.get_newest_by_category()
...
def test_best_by_age_with_category():
    item_a = Clothing(age=2.0)
    ...
    assert best_item.category == "Electronics"
