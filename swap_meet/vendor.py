class Vendor:
  ...
  def swap_best_by_category(self, vendor_2, my_priority, their_priority):
    return self.swap_items(vendor_2, self.get_best_by_category(their_priority), vendor_2.get_best_by_category(my_priority))
